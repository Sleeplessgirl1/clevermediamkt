...
const Index = () => {
  ...
  const logos = ["/logo (1).png", "/logo (2).png", "/logo (3).png", "/logo (4).png", "/logo (5).png", "/logo (6).png", "/logo (7).png", "/logo (8).png", "/logo (9).png", "/logo (10).png", "/logo (11).png", "/logo (12).png", "/logo (13).png", "/logo (14).png", "/logo (15).png", "/logo (16).png", "/logo (17).png"];
  const greenFlags = [{
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="relative z-20">
        <Navigation className="border-secondary bg-[#4aa9ae]" />
      </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className={`container mx-auto px-4 transition-all duration-1000 relative z-10 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="mb-8 animate-scale-in flex justify-center">
            <img src={encodeURI("/PONTE CLEVER.png")} alt="PONTE CLEVER!!" className="max-w-full h-auto drop-shadow-lg" style={{
            maxHeight: "250px"
          }} // Un poco más grande para el hero
          />
          </div>
      ...
      <section className="section-container bg-background overflow-hidden">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-gothic font-bold text-center mb-20 animate-fade-in-up leading-tight">
            ¿POR QUÉ SOMOS UNA <span className="text-lime-500 bg-[#f0f6ff]">GREEN FLAG?</span>
          </h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {greenFlags.map((flag, index) => <Card key={index} className="p-8 hover-lift hover-glow border-2 hover:border-secondary transition-all animate-scale-in group" style={{
      ...
      background: "linear-gradient(135deg, hsl(183 47% 57%), hsl(184 42% 47%))"
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="p-10 hover-lift hover-glow bg-white/95 backdrop-blur-sm border-2 border-white/50 animate-scale-in group" style={{
            animationDelay: `${index * 0.15}s`
          }}>
        ...
        <div className="container mx-auto px-4">
          ...
          delay: 2000
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              ...
              {logos.map((src, index) => <CarouselItem key={index} className="pl-2 md:pl-4 basis-1/2 md:basis-1/4 lg:basis-1/6">
                  <div className="p-2">
                    <Card className="transition-all border border-white/10 bg-[#1d1d1d] rounded-xl">
                      <div className="aspect-square flex items-center justify-center p-6">
                        <div className="w-full h-full flex items-center justify-center">
                          <img src={src} alt={`Logo ${index + 1}`} className="max-w-[75%] max-h-[75%] object-contain" />
                        </div>
                      </div>
                    </Card>
                  </div>
